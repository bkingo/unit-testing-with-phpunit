...
class ColletionTest extends TestCase
{
    ...
    public function collection_can_be_iterated()
    {
        ...
        // we've already verified that the $collection is iterable ;)
    ...
    /** @test */
    public function collection_can_be_merged_with_another_colleciton()
    {
    ...
    public function returns_json_encoded_items()
    {
        ...
        //$this->assertInternalType('string', $collection->toJson()); <---- this doesn't work
    ...
    public function json_encoding_a_collection_object_returns_json()
    {
        ...
        //$this->assertInternalType('string', $encoded); <---- this doesn't work
